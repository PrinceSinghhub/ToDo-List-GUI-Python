...
canvas.create_text(88, 73.0, text="Application By",
                   fill="#ffffff",
                   font=("Roboto-Bold", int(18.0)))

canvas.create_text(88.0, 110.5, text="CODEX CODER",
                   fill="#ffffff",
...
canvas.create_text(55.0, 150.5, text="To-Do: ",
                   fill="#ffffff",
                   font=("Roboto-Bold", int(18.0)))
canvas.create_text(120.0, 180.5, text="Add Your Task and Chess",
                   fill="#ffffff",
...
img_delete = PhotoImage(file = "img_delete.png")
